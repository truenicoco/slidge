...
from slixmpp.xmlstream import ET, JID, ElementBase, register_stanza_plugin
...
class Label(ElementBase):
    ...
    interfaces = {"HOME", "WORK", "POSTAL", "PARCEL", "DOM", "INT", "PREF", "lines"}
    bool_interfaces = {"HOME", "WORK", "POSTAL", "PARCEL", "DOM", "INT", "PREF"}
